    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_link', models.CharField(default='/media/images/summary.jpg', max_length=255, verbose_name='图片地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='导航大分类')),
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='EOSONES的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('keywords', models.TextField(default='EOSONES,网络,IT,技术,博客,Python', help_text='用来作为SEO中keywords,长度参考SEO标准', max_length=240, verbose_name='关键字')),
            ],
            options={
                'verbose_name': '一级导航',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='admin与数据库中标题可以为空', max_length=20, null=True, verbose_name='标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='EOSONES的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('bigcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Category', to='Storm.BigCategory', verbose_name='大分类')),
            ],
            options={
                'verbose_name': '二级导航',
